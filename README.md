...
Log in to MetaMask, copy the mnemonic and import it to MetaMask. This will enable the accounts generated by Ganache (see [Truffle Pet-Shop tutorial](http://truffleframework.com/tutorials/pet-shop)). Set MetaMask to lokal rpc server: **http://127.0.0.1:7545**
